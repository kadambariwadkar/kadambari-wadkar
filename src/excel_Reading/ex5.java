...
public class ex5 {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		  ...
		  String value1 =  WorkbookFactory.create(myFile).getSheet("Sheet1").getRow(0).getCell(0).getStringCellValue();
				  ...
				  double value2 = 
				  WorkbookFactory.create(myFile).getSheet("Sheet1").getRow(0).getCell(1).getNumericCellValue
				  ();
				  System.out.println(value2);
				  boolean value3 = 
				  WorkbookFactory.create(myFile).getSheet("Sheet1").getRow(0).getCell(2).getBooleanCellValue
				  ();
