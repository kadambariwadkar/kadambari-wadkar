...
public class UtilItyNew {
	...
	//create object of FileInputStream and pass properties file path as a
	
	FileInputStream myFile= new
	FileInputStream("D:\\eclipse-workspace\\Selenium_Study\\neostox.properties");
	prop.load(myFile);
	...
	File dest= new File("E:\\\\Screenshort\\"+screenShotName+".png");
